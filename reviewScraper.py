...
class ReviewScraper(models.Manager):
    def new_review(self, store_name, user, title_review, body_review, rating, possible_rating, location=None, date_review, helpful=None, not_helpful=None):
        ...
        if filepath:         
            ...
            with open(csvpath, "w") as csvfile:
                fieldnames = ['store_name', 'user', 'title_review', 'body_review', 'rating', 'possible_rating', 'location', 'date_review', 'helpful', 'not_helpful']
