...
def new_review(store_name, user, body_review, rating, possible_rating, date_review, title_review=None,location=None, helpful=None, not_helpful=None, id_review=None):
    filepath = os.path.join("reviews", f"{store_name}.csv")
    new_review_data = []       
